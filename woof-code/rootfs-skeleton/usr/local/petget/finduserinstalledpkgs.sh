...
#/var/packages/usr-installed-packages has the list of installed pkgs...
touch /var/packages/user-installed-packages
cut -f 1,5,10 -d '|' /var/packages/user-installed-packages > /tmp/petget/installedpkgs.results
